...
Deno.test('the sub-line is the one exemption, and only on `focus`', () => {
  ...
  // Michael's wording, 2026-08-25 — replaced "Dial in the 2 areas you want to focus on."
  assertEquals(DIAL_SUBLINE, 'Swap exercises per your preference or add work for 2 areas you want to focus on.');
...
Deno.test('the dose line agrees with the rows', () => {
  ...
  assertEquals(ACCESSORY_DOSE_LINE, '6 to 12 reps, controlled eccentric, controlled concentric (0 to 2 RIR), 3 to 4 sets. Fatigue is not the enemy because repetitions will inevitably slow as fast-twitch fibers become exhausted.');
