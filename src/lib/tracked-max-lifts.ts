 ...
 *      this cycle, that IS the squat slot and it earns 5/3/1 language.
 *   2. **"Do we chart a max for it?"** → this list, exactly four. In 5/3/1 you hold a TRAINING MAX on
 ...
 *
 * ⚠️ Deliberately NOT derived from `MAIN_531_LIFTS`. That set answers question 1 and includes slot
