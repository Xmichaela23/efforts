 ...
 * out: strength_frequency 0), **swim_intent** (`focus` | `race`), optional **swim_experience**
 * (`learning` | `steady` | `strong` — wizard / chat), plus preferred_days (long ride/run, swim[], quality_run + easy_run,
