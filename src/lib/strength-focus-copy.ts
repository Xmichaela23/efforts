 ...
 * ("8 to 12 reps, 1 to 2 in reserve…" — p218 says 6 to 12, 0 to 2), `STANDING_ME_SET_CUE` ("{band} reps,
 * stop short of failure." — the stop clause is not quoted in the SOURCE doc) and `STANDING_DE_SET_CUE`
 * (no caller). Every screen now prints `intentLine` from `@shared/strength-grid/intents`.
 */
