/**
 * Calendar YYYY-MM-DD helpers — parse in the user's local timezone without
 * UTC-midnight day shifts (`new Date('YYYY-MM-DD')` parses as UTC).
 * Keep in sync with `supabase/functions/_shared/parse-local-date.ts`.
 */
...
/** Monday YYYY-MM-DD for the device's current calendar week */
