...
const PlateMath: React.FC<{ 
  ...
  return (
    <div className="mt-1 p-2 bg-zinc-900/80 backdrop-blur-md border border-white/20 rounded-lg text-xs">
...
export default function StrengthLogger({ onClose, scheduledWorkout, onWorkoutSaved, targetDate }: StrengthLoggerProps) {
  ...
  if (!isInitialized) {
    return (
      ...
      >
        <div className="bg-zinc-900/70 backdrop-blur-md border border-white/20 pb-4 mb-4 rounded-2xl">
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between w-full px-4">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              <button onClick={()=>{ setShowPlannedMenu(v=>!v); setShowAddonsMenu(false); }} className="text-sm px-3 py-1.5 rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/15 text-white/90 hover:bg-zinc-900/90 transition-all duration-300" style={{ fontFamily: 'Inter, sans-serif' }}>Pick planned</button>
              {showPlannedMenu && (
                <div className="absolute right-0 mt-1.5 w-72 bg-zinc-900/90 backdrop-blur-md border border-white/20 rounded-xl shadow-2xl z-[100] p-2">
            ...
            <div className="relative">
              ...
              {false && (
                <>
                  <button onClick={()=>{ setShowAddonsMenu(v=>!v); setShowPlannedMenu(false); }} className="text-sm px-3 py-1.5 rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/15 text-white/90 hover:bg-zinc-900/90 transition-all duration-300" style={{ fontFamily: 'Inter, sans-serif' }}>Warm‑up • Core</button>
                  {showAddonsMenu && (
              <div className="absolute right-0 mt-1.5 w-72 bg-zinc-900/90 backdrop-blur-md border border-white/20 rounded-xl shadow-xl z-50 p-2">
                <div className="space-y-1">
                  <div>
                    <div className="text-xs text-white/60 px-1 mb-1">Warm‑Up</div>
                    {!showWarmupChooser ? (
                      <div className="grid grid-cols-2 gap-2">
                        <button onClick={()=>attachAddon('addon_strength_wu_5')} className="px-2 py-1.5 rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/20 text-white/90 hover:bg-zinc-900/90 transition-all duration-300 text-sm" style={{ fontFamily: 'Inter, sans-serif' }}>5 min</button>
                      </div>
                    ) : (
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button onClick={()=>attachAddon('addon_core_5')} className="px-2 py-1.5 rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/20 text-white/90 hover:bg-zinc-900/90 transition-all duration-300 text-sm" style={{ fontFamily: 'Inter, sans-serif' }}>5 min</button>
                    </div>
                  </div>
      ...
      <div className="space-y-2 w-full pb-3">
        {attachedAddons.length>0 && (
          <div className="px-3 space-y-2">
            {attachedAddons.map((a,idx)=> (
              <div key={idx} className="rounded-xl bg-zinc-900/70 backdrop-blur-md border border-white/10">
                <div className="flex items-center justify-between p-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!a.completed ? (
                      ...
                      }} className="px-2 py-1 text-xs rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/20 text-white/90 hover:bg-zinc-900/90 transition-all duration-300" style={{ fontFamily: 'Inter, sans-serif' }}>
                ...
                {a.sequence && a.sequence.length>0 && (
                  <div className="px-2 pb-1.5">
                    ...
                    <div className="divide-y divide-white/15 border border-white/20 rounded-xl bg-zinc-900/80">
          ...
          <div className="px-3">
            <div className="flex items-center flex-wrap gap-2 text-sm">
              ...
              {pendingOrOptions.map((opt, idx) => (
                <button
                  key={idx}
                  className="px-2 py-1 rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/20 text-white/90 hover:bg-zinc-900/90 transition-all duration-300"
                  style={{ fontFamily: 'Inter, sans-serif' }}
                  onClick={() => {
                ...
                {exercises.length > 1 && (
                  <div className="flex justify-end mt-2">
                    <button 
                      ...
                      className="px-3 py-1.5 rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/20 text-white/70 hover:text-red-400 hover:bg-zinc-900/90 hover:border-red-400/50 transition-all duration-300 text-sm flex items-center gap-1"
                      style={{ fontFamily: 'Inter, sans-serif' }}
                    >
            ...
            <div className="p-2">
              <div className="flex items-center justify-between gap-2">
                <div className="flex-1 relative">
                  <div className="flex items-center border border-white/15 bg-zinc-900/80 backdrop-blur-sm rounded-xl">
                  ...
                  {activeDropdown === exercise.id && exercise.name.length > 0 && (
                    <div className="absolute top-11 left-0 right-0 bg-zinc-900/90 backdrop-blur-md border border-white/20 rounded-xl shadow-xl z-50 max-h-32 overflow-y-auto">
            ...
            {(expandedExercises[exercise.id] !== false) && (
              <div className="px-3 py-1.5">
                {exercise.sets.map((set, setIndex) => {
                  ...
                  return (
                    <div key={setIndex} className={`bg-zinc-900/60 backdrop-blur-md border border-white/15 rounded-xl p-2 shadow-[0_0_0_1px_rgba(255,255,255,0.05)_inset,0_4px_12px_rgba(0,0,0,0.2)] ${showRestTimer ? "mb-4" : "mb-1"}`}>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        set.reps === undefined ? null : (
                          <Input
                            ...
                            className="h-9 text-center text-sm border-white/25 bg-zinc-900/80 backdrop-blur-md rounded-xl text-white placeholder:text-white/40 flex-1 focus-visible:ring-0 focus-visible:border-white/35 focus-visible:bg-zinc-900/90"
                            style={{ fontSize: '16px', fontFamily: 'Inter, sans-serif' }}
                            placeholder="Reps"
                          />
                        )
                      ...
                      {(() => {
                        ...
                        if (exerciseType === 'band') {
                          return (
                            ...
                            >
                              <SelectTrigger className="h-9 text-center text-sm border-white/25 bg-zinc-900/80 backdrop-blur-md rounded-xl text-white placeholder:text-white/40 flex-1 focus:ring-0 focus:border-white/35 focus:bg-zinc-900/90">
                                <SelectValue placeholder="Resistance" />
                              </SelectTrigger>
                              <SelectContent className="bg-zinc-900/90 backdrop-blur-md border border-white/20 shadow-xl z-50 text-white/90">
                      ...
                      <button
                        ...
                        className={`text-xs px-2 py-1 rounded-full min-h-[28px] transition-all duration-300 ${set.completed ? 'bg-cyan-400/20 border border-cyan-400/50 text-cyan-400' : 'bg-zinc-900/80 backdrop-blur-sm border border-white/25 text-gray-300 hover:bg-zinc-900/90 shadow-[0_0_0_1px_rgba(255,255,255,0.05)_inset,0_2px_8px_rgba(0,0,0,0.15)] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.08)_inset,0_2px_8px_rgba(0,0,0,0.2)]'}`}
                        style={{ fontFamily: 'Inter, sans-serif' }}
                      >
                      ...
                      <button
                        ...
                        className="p-2 rounded-full bg-zinc-900/80 backdrop-blur-sm border border-white/25 text-white/60 hover:text-red-400 hover:bg-zinc-900/90 hover:border-red-400 transition-all duration-300 h-8 w-8 flex items-center justify-center flex-shrink-0"
                    ...
                    {showRestTimer && (
                      <div className="flex items-center gap-2 mt-4 mb-2 ml-8 relative">
                        ...
                        <button
                          ...
                          className="h-7 px-2 text-xs rounded-md border border-white/25 bg-zinc-900/80 backdrop-blur-sm text-white hover:bg-zinc-900/90 transition-all duration-300"
                          style={{ fontFamily: 'Inter, sans-serif' }}
                ...
                <button 
                  ...
                  className="w-full h-8 text-xs px-3 py-1.5 rounded-full bg-zinc-900/80 backdrop-blur-md border border-white/25 text-white hover:bg-zinc-900/90 transition-all duration-300 flex items-center justify-center gap-2 mt-0"
                  type="button"
                  style={{ fontFamily: 'Inter, sans-serif' }}
                >
        ...
        <div className="relative bg-zinc-900/70 backdrop-blur-md border border-white/10 rounded-2xl px-3 pt-0 pb-0">
          <div className="relative flex items-center border border-white/25 bg-zinc-900/80 backdrop-blur-lg rounded-lg">
      ...
      <div className="fixed bottom-0 left-0 right-0 px-4 py-3 bg-zinc-900/80 backdrop-blur-md border-t border-white/20 z-[100]" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 12px)' }}>
        <button 
          onClick={saveWorkout}
          className="w-full h-12 text-base font-medium text-white transition-colors rounded-full bg-cyan-700/80 backdrop-blur-md border border-cyan-500/40 hover:bg-cyan-700/90"
          style={{ fontFamily: 'Inter, sans-serif' }}
        >
          Save
        </button>
      ...
      {showNotesModal && (
        <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center">
          ...
          <div className="relative w-full sm:w-[520px] bg-zinc-900/90 backdrop-blur-md border border-white/20 rounded-t-2xl sm:rounded-xl shadow-2xl p-4 sm:p-6 z-10 max-h-[80vh] overflow-auto" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 12px)' }}>
            ...
            <div className="space-y-3">
              <div>
                ...
                }} rows={4} className="mt-1 w-full bg-zinc-900/80 backdrop-blur-sm border border-white/15 rounded-lg p-2 text-sm text-white/90 placeholder:text-white/40 focus:outline-none focus:border-white/25" placeholder="" style={{ fontFamily: 'Inter, sans-serif' }} />
              </div>
              <div>
                ...
                }} className="mt-1 w-full bg-zinc-900/80 backdrop-blur-sm border border-white/15 rounded-lg p-2 text-sm text-center text-white/90 placeholder:text-white/40 focus:outline-none focus:border-white/25" placeholder="—" style={{ fontFamily: 'Inter, sans-serif' }} />
              </div>
            </div>
            <div className="mt-4 sticky bottom-0 bg-zinc-900/80 backdrop-blur-md pt-3 rounded-lg">
      ...
      {showSessionRPE && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center">
          ...
          <div className="relative w-full max-w-md mx-4 bg-zinc-900/90 backdrop-blur-md border border-white/20 rounded-xl shadow-xl p-6 z-10">
            {isSaving ? (
              ...
              <>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-4 rounded-full bg-zinc-900/80 border border-white/20 text-white/80 hover:bg-zinc-900/90 hover:text-white transition-all duration-300"
                    style={{ fontFamily: 'Inter, sans-serif' }}
                  >
                    Skip
                  </button>
