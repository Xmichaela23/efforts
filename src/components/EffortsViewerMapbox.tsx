            ...
            if (source === 'strava' || stravaId || isStravaImported) {
              ...
              return (
                <a 
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: 4, textDecoration: 'none', color: '#64748b', fontSize: 12 }}
                  title={stravaUrl ? 'View on Strava' : undefined}
                >
                  <span style={{ color: '#94a3b8' }}>via</span>
                  <svg width="50" height="12" viewBox="0 0 100 24" fill="#FC4C02">
                    <path d="M5.6 16.8c-2.1 0-3.6-.6-4.6-1.5l1.3-2.4c.7.7 1.8 1.2 3.1 1.2 1.1 0 1.7-.3 1.7-.9 0-.6-.5-.8-2.1-1.1C2.4 11.6.6 10.6.6 8.1c0-2.3 2-3.9 4.7-3.9 1.8 0 3.4.5 4.4 1.4L8.4 8c-.7-.6-1.7-1-2.8-1-.9 0-1.4.3-1.4.8 0 .6.5.8 2 1.1 2.7.5 4.6 1.3 4.6 4 0 2.4-1.9 3.9-5.2 3.9zm12.8-12.4v2.8h3v2.5h-3v4c0 .9.4 1.2 1.1 1.2.6 0 1.2-.2 1.7-.4l.7 2.4c-.8.4-1.8.7-2.9.7-2.3 0-3.6-1.1-3.6-3.6v-4.3h-1.8V7.2h1.8V4.4h3zm5.4 2.8h3v1.4c.6-1 1.7-1.6 3.1-1.6v2.9c-.2 0-.4-.1-.7-.1-1 0-1.9.5-2.4 1.3v5.5h-3V7.2zm14.7 9.5c-.6.3-1.5.4-2.2.4-1.6 0-2.5-.9-2.5-2.5v-.3c-.7.4-1.5.6-2.4.6-1.7 0-2.8-1-2.8-2.5 0-1.7 1.3-2.6 3.5-2.6.6 0 1.2.1 1.7.2v-.3c0-.8-.5-1.2-1.7-1.2-.9 0-1.8.2-2.6.6l-.7-2.1c1-.5 2.3-.8 3.7-.8 2.6 0 4.2 1.1 4.2 3.5v4.2c0 .5.2.7.7.7.2 0 .5 0 .7-.1l.4 1.8v.4zm-4.7-3.6v-1.3c-.3-.1-.7-.1-1-.1-.9 0-1.3.3-1.3.9 0 .5.4.8 1 .8.5 0 1-.2 1.3-.3zm8.5 3.5l-3.8-9.4h3.2l2.2 6.1 2.2-6.1h3.2l-3.8 9.4h-3.2zm16.3 0c-.6.3-1.5.4-2.2.4-1.6 0-2.5-.9-2.5-2.5v-.3c-.7.4-1.5.6-2.4.6-1.7 0-2.8-1-2.8-2.5 0-1.7 1.3-2.6 3.5-2.6.6 0 1.2.1 1.7.2v-.3c0-.8-.5-1.2-1.7-1.2-.9 0-1.8.2-2.6.6l-.7-2.1c1-.5 2.3-.8 3.7-.8 2.6 0 4.2 1.1 4.2 3.5v4.2c0 .5.2.7.7.7.2 0 .5 0 .7-.1l.4 1.8v.4zm-4.7-3.6v-1.3c-.3-.1-.7-.1-1-.1-.9 0-1.3.3-1.3.9 0 .5.4.8 1 .8.5 0 1-.2 1.3-.3z"/>
                  </svg>
                </a>
              );
            }
