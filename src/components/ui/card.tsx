...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("font-light leading-none tracking-normal text-card-foreground", className)}
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm font-light tracking-normal text-muted-foreground", className)}
    style={{ fontFamily: 'Inter, sans-serif' }}
    {...props}
  />
))
