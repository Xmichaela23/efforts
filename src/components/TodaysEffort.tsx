...
const TodaysEffort: React.FC<TodaysEffortProps> = ({ 
  ...
  return (
    <div className="w-full flex-shrink-0 flex flex-col overflow-hidden" style={{fontFamily: 'Inter, sans-serif', height: 'var(--todays-h)', position:'relative'}}>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto overscroll-y-auto scrollbar-hide" style={{ WebkitOverflowScrolling: 'touch', scrollBehavior: 'smooth' as any, minHeight: 0, maxHeight: '100%', position: 'relative', touchAction: 'pan-y', overscrollBehavior: 'contain' }}>
        <div className="px-3" style={{ paddingBottom: hasExpandedWorkout ? 120 : 48, width: '100%', minHeight: '100%' }}>
