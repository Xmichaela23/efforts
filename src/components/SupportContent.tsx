...
/**
 * The Support content, shown in two places: the signed-in screen inside the app (AppLayout, with the
 * tab bar) and the public page at /support that is given to Strava and Garmin as the support site.
 * Anything here describing what we do with connected data must agree with /privacy.
 */
