...
- **USE ALL BASELINE DATA:**
  ...
  const generatePlan = async () => {
    try {
      ...
      console.log('✅ Plan generated by PlanEngine with AI parameters:', result);
      ...
      const plan = {
        ...
        plan: result, // Use the AI-driven plan structure
        fullPlan: { plan: result },
        aiAnalysis: aiAnalysis // Store AI analysis for debugging
      };
