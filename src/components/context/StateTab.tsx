...
export default function StateTab({
  ...
  const aimlessSubtext = serverEmptyState?.subtitle ?? 'Plans for riders and runners: get strong, get fast, or train for a race.';
  ...
  return (
    <div className="pt-1 pb-4">
      ...
      {/* Rule 4: one label system — uppercase, tracked, like BODY / STRENGTH. The "trends · last 12 weeks" heading is
          drawn by <StatePerformanceSection> on one line with Reorder (2026-09-18) — passed as `heading` below. */}
