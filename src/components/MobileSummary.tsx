    ...
    <div className="w-full">
      ...
      {(() => {
        ...
        try {
          ...
          console.log('🔍 [EXECUTION SCORE DEBUG] completed.computed.overall:', (completed as any)?.computed?.overall);
          console.log('🔍 [EXECUTION SCORE DEBUG] executionScore:', executionScore);
