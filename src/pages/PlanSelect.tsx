    ...
    try {
      ...
      for (const [wkNum, sessions] of selectedWeeks) {
        ...
        for (const s of sessions as any[]) {
          ...
          // Strength exercises saved as-is - server handles equipment substitution and weight calculation
          if ((String(s.discipline||s.type||'').toLowerCase() === 'strength') && Array.isArray(copy.strength_exercises) && copy.strength_exercises.length > 0) {
            console.log('💪 Strength workout - exercises will be processed by server');
            console.log('🔍 Original exercises:', copy.strength_exercises);
            //  Server will substitute based on user equipment and calculate weights
          }
