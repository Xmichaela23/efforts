...
// ⛔ `normalizeStructuredSession` IS DELETED (2026-09-10, audit H-T18). It priced a `workout_structure` row
// off today's baselines for a subtitle; its last callers print the server's `friendly_summary` or the description.
