# Test Plan — first_race / learning / none / bodyweight_bands / 70.3 / 8hr
...
### Week 14 — race_specific (TSS 285)
- **Tuesday**
  - Easy Ride — 0.8 hr (bike · 45min · EASY)
    Recovery spin at Z1–Z2. No pushing. Legs should feel loose and refreshed by the end.
  - Technique Aerobic Swim — 1250 yd (swim · 36min · EASY)
    Warm up 300 yd easy. Efficiency-first: sharpen one or two mechanics before aerobic volume so every yard transfers to the race. Prescribed drills: 2×50 Fingertip Drag (high-elbow recovery); 2×50 Sighting Drill (head-up race-day navigation); 2×50 Catch-Up (front-quadrant timing). 4×150 yd at easy aerobic pace. Focus on technique: high elbow catch, bilateral breathing. Cool down 200 yd.
- **Wednesday**
  - Easy Ride — 0.8 hr (bike · 45min · EASY)
    Recovery spin at Z1–Z2. No pushing. Legs should feel loose and refreshed by the end.
- **Thursday**
...
- **Friday**
  - Technique Aerobic Swim — 1700 yd (swim · 49min · EASY)
    Warm up 300 yd easy. Efficiency-first: sharpen one or two mechanics before aerobic volume so every yard transfers to the race. Prescribed drills: 2×50 Single-Arm Freestyle (rotation + balanced pull). 7×150 yd at easy aerobic pace. Focus on technique: high elbow catch, bilateral breathing. Cool down 200 yd.
  - Easy Run — 3 mi (run · 30min · EASY)
    Recovery run. Fully conversational Z1–Z2 pace. These miles build your aerobic base without adding meaningful fatigue.
- **Saturday**
  - Brick — Bike 2.3 hr (bike · 135min · EASY)
