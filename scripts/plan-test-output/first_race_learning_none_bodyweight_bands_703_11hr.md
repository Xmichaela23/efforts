# Test Plan — first_race / learning / none / bodyweight_bands / 70.3 / 11hr
...
- **Wednesday**
  ...
  - Easy Ride — 1.4 hr (bike · 83min · EASY)
    Recovery spin at Z1–Z2. No pushing. Legs should feel loose and refreshed by the end.
- **Thursday**
...
- **Wednesday**
  - Swim Time Trial — 1400 yd (swim · 39min · HARD)
    Warm up 500 yd with progressive build (last 100 at moderate effort). 400 yd MAX effort — sustained hard, hold form. 4 min easy recovery (back-and-forth jogs or float). 200 yd MAX effort — leave nothing. Cool down 300 yd easy. The engine will recompute your 100yd pace target from these two splits.
  - Easy Ride — 1.1 hr (bike · 66min · EASY)
    Recovery spin at Z1–Z2. No pushing. Legs should feel loose and refreshed by the end.
- **Thursday**
  - Tempo Run — 3 mi at threshold (run · 51min · MODERATE)
    Warm up 1.5 mi easy, then 3 mi at lactate threshold (comfortably hard — 7–8 RPE, can say a few words). Cool down 1.5 mi easy.
- **Friday**
  - Technique Aerobic Swim — 2350 yd (swim · 67min · EASY)
    Warm up 300 yd easy. Efficiency-first: sharpen one or two mechanics before aerobic volume so every yard transfers to the race. Prescribed drills: 2×50 Single-Arm Freestyle (rotation + balanced pull). 12×150 yd at easy aerobic pace. Focus on technique: high elbow catch, bilateral breathing. Cool down 200 yd.
  - Easy Run — 3 mi (run · 30min · EASY)
    Recovery run. Fully conversational Z1–Z2 pace. These miles build your aerobic base without adding meaningful fatigue.
- **Saturday**
  - Brick — Bike 2.3 hr (bike · 135min · EASY)
