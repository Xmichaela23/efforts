...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Note: workout_analysis is now generated ONLY by discipline-specific analyzers
    // (analyze-running-workout, analyze-strength-workout, etc.)
    ...
    return new Response(JSON.stringify({ 
      ...
      note: 'workout_analysis is generated by discipline-specific analyzers only'
