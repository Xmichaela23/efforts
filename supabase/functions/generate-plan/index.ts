  ...
  try {
    ...
    return new Response(
      JSON.stringify({
        ...
        validatedData: {
          distance: userContext.responses.distance,
          disciplineFocus: userContext.responses.disciplineFocus,
          strengthTraining: userContext.responses.strengthTraining,
          trainingFrequency: userContext.responses.trainingFrequency,
          weeklyHours: userContext.responses.weeklyHours
        }
      }),
      {
        status: 200,
