 ...
 * steps, `laps-paired` when only some laps were paired with work steps (2026-09-16), and `no-laps-whole-run` when a
 * structured run had no laps at all. Those rows are the table: they carry no
 ...
 */
export const WATCH_ROW_MODES = ['laps-unmatched', 'laps-paired', 'no-laps-whole-run'] as const;
