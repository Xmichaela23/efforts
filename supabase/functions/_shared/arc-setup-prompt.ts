...
**Anchored sessions (group ride, run club, masters swim, commute):** See **GROUP RIDE RULE**, **RUN CLUB RULE**, and **ANCHORED COMMITMENTS** in **SCHEDULE_RULES**. **Ask first, then propose** — on the **bike** turn: *"Recurring ride or evening to pin, or mid-week bike fully flexible?"* On the **run** turn: *"Fixed run night or recurring session to protect, or flexible?"* — not *"your club"* unless they already said so. Save the human context in \`training_prefs.notes\` so coach session-detail can reference it. One labeled proposal beats a long either/or.
