...
// signal is the per-exercise e1RM TREND (the standard formula per D-339, canonical from exercise_log
// — single-sourced).
...
Signals: estimated 1RM per exercise (canonical from exercise_log — single-sourced), RIR, volume, load, per-exercise history. There is NO pace / HR / zone signal — strength has no endurance effort metric.
