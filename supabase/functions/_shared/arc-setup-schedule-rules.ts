...
**Ask before prescribing.** Group rides, run groups, track sessions, masters swim, regular workout-buddy days, and commute-bike days are **anchors** when they exist — they will not move and the athlete will skip the plan before they skip the commitment. **Build the schedule around anchors**, by asking **once per discipline** whether anything is fixed — **without assuming** a club: e.g. *"Mid-week bike flexible, or a recurring ride to pin?"* and *"Any fixed run you want protected, or flexible?"* — **before** stating proposed weekday roles. A plan that fights existing commitments will be abandoned.
