 ...
 * Caller must be authenticated; user_id must match JWT sub.
 */
...
serve(async (req: Request) => {
  ...
  try {
    ...
    const body = (await req.json()) as { user_id?: string; as_of?: string };
    ...
    const snapshot = await buildReadiness(supabase, body.user_id, asOf);
