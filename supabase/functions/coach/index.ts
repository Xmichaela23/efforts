...
import { rollupFitnessDirection, rollupFitness, type FitnessDirection, resolveStrengthCapacity, canonicalizeLiftKey, decouplingLabel, decouplingBandDisplay, bikeRideIntensityAerobic, bikeEfficiencyDisplay } from '../_shared/state-trend/index.ts';
import {
