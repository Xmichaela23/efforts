    ...
    // a claim, not a reading.
    {
      ...
      if (rpeRow) {
        ...
        if (cur != null && base != null) {
          ...
          rpeRow.detail = `usual ${base.toFixed(1)}${note}`;
        }
        const extra: any[] = [];
