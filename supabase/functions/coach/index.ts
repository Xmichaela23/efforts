        ...
        cross_training_signal: (() => {
          ...
          //    a declared FOCUS and a real trade/cost/room story; else falls through to the reassurance.
          {
            ...
            if (stv) {
              ...
              if (ctRead) return { label: ctRead.headline, tone: ctRead.tone, detail: ctRead.detail, info: (ctRead as any).info ?? null };
            }
          }
