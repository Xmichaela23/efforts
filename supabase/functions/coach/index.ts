...
const COACH_PAYLOAD_VERSION = 68; // 68: D-267 Fix 1 — load_status.interpretation VALUES changed (plan-primary re-classification: strength-primary run-shortfall reads "strength on plan; cross-training carried it" not "build more"). Bump so cached rows recompute. // 67: delete vague "N concerning signals" count fallback (readiness_why null when no named driver).
