          ...
          //    a declared FOCUS and a real trade/cost/room story; else falls through to the reassurance.
          {
            ...
            if (stv) {
              ...
              const ctStates = [
                ...
                { discipline: 'run', posture: ctPosture.run || 'unknown', verdict: stv.run?.decoupling?.verdict || 'needs_data', acwr: runningAcwr ?? null },
