        ...
        cross_training_signal: (() => {
          ...
          //    a declared FOCUS and a real trade/cost/room story; else falls through to the reassurance.
          {
            ...
            if (stv) {
              ...
              const ctStates = [
                { discipline: 'strength', posture: ctPosture.strength || 'unknown', verdict: stv.strength?.verdict || 'needs_data', acwr: null },
