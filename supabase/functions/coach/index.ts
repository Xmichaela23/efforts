...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const fitnessFatigue = { ...fitnessFatigueToday, week_ago: { fitness: fitnessFatigueWeekAgo.fitness, fatigue: fitnessFatigueWeekAgo.fatigue, form: fitnessFatigueWeekAgo.form } };
