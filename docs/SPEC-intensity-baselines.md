...
- **Refresh = honored-swim-gated nudge** (STATE screen only — NOT Performance; Michael 2026-06-18: it's a fitness-marker insight, belongs with the markers, not in the baseline editor) — RULE LOCKED 2026-06-18, NOT YET BUILT:
