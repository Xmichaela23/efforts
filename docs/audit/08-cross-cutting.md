...
- `docs/archive/GOALS_SYSTEM_BLUEPRINT.md`, `docs/PRODUCT-POSITIONING.md`, `docs/ENGINE-STATE.md`, `docs/MAINTENANCE-DEBT.md` — to reconcile the goals lifecycle and dead-stub inventory against documented intent.
