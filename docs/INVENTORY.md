...
| `plan-refresh.ts` | `endurance-checkpoint` · `get-week` · `materialize-plan` · `rematerialize-standing-block` |
...
| `strength-test-key.ts` | `analyze-strength-workout` · `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `materialize-plan` · `rematerialize-standing-block` · `save-baseline-test` · `strength-test-session` |
...
### `supabase/functions/_shared/accessory-dosing/` — 5 files · anything in it → 26 functions
...
| `index.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-list` |
...
| touch this file | redeploy these |
|---|---|
| `anchors.ts` | `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-list` · `swap-session` |
| `classification.ts` | `analyze-running-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-list` · `swap-session` · `workout-detail` |
...
### `supabase/functions/_shared/standing-plan/` — 30 files · anything in it → 15 functions

`analyze-strength-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `get-week` · `materialize-plan` · `rematerialize-standing-block` · `save-baseline-test` · `strength-test-session` · `swap-list` · `swap-session`

| touch this file | redeploy these |
|---|---|
| `accessory-picks.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-list` |
| `compose.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `rematerialize-standing-block` |
| `day-map.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-list` |
...
| `frames.ts` | `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-list` · `swap-session` |
...
| `plyo.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `rematerialize-standing-block` · `swap-list` |
...
| `warmup.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `materialize-plan` · `rematerialize-standing-block` · `strength-test-session` |
...
| `working-number.ts` | `analyze-strength-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `get-week` · `materialize-plan` · `rematerialize-standing-block` · `save-baseline-test` · `strength-test-session` · `swap-list` · `swap-session` |
...
### `supabase/functions/_shared/strength/` — 9 files · anything in it → 37 functions
...
| `strength-display-lines.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `materialize-plan` · `rematerialize-standing-block` · `strength-test-session` |
| `substitution-note.ts` | `analyze-strength-workout` |
| `test-session.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `materialize-plan` · `rematerialize-standing-block` · `strength-test-session` |
...
### `supabase/functions/generate-combined-plan/` — 2 files · anything in it → 26 functions
...
### `supabase/functions/generate-run-plan/` — 3 files · anything in it → 28 functions
