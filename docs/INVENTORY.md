...
| `plain-intent.ts` | `calendar-sync` |
| `plan-wizard-distance-label.ts` | `athletic-record` |
| `pullup-progression.ts` | `analyze-strength-workout` · `compute-snapshot` · `rematerialize-standing-block` · `save-baseline-test` |
...
### `supabase/functions/_shared/` — 138 files · anything in it → 85 functions
...
| `plan-phase.ts` | `adapt-plan` · `analyze-cycling-workout` · `analyze-running-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `course-detail` · `course-strategy` · `create-goal-and-materialize-plan` · `delete-plan` · `endurance-checkpoint` · `generate-combined-plan` · `generate-strength-plan` · `generate-triathlon-plan` · `get-arc-context` · `get-week` · `import-strava-history` · `ingest-phone-workout` · `learn-fitness-profile` · `materialize-plan` · `plan-overview` · `planning-context` · `post-import-athlete-pipeline` · `refresh-goal-race-projections` · `rematerialize-standing-block` · `strava-webhook` · `swap-session` · `workout-detail` |
| `plan-week.ts` | `adapt-plan` · `analyze-cycling-workout` · `analyze-running-workout` · `analyze-strength-workout` · `analyze-swim-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `course-detail` · `course-strategy` · `create-goal-and-materialize-plan` · `delete-plan` · `endurance-checkpoint` · `generate-combined-plan` · `generate-strength-plan` · `generate-triathlon-plan` · `get-arc-context` · `get-week` · `import-strava-history` · `ingest-phone-workout` · `learn-fitness-profile` · `plan-overview` · `planning-context` · `post-import-athlete-pipeline` · `refresh-goal-race-projections` · `rematerialize-standing-block` · `rematerialize-strength-block` · `strava-webhook` · `swap-session` · `workout-detail` |
...
| `provider-deregister.ts` | `delete-account` · `disconnect-connection` · `garmin-webhook-user` · `intervals-oauth` |
...
| `strength-test-key.ts` | `analyze-strength-workout` · `rematerialize-standing-block` · `save-baseline-test` · `strength-test-session` |
...
### `supabase/functions/_shared/accessory-dosing/` — 5 files · anything in it → 25 functions
...
| `index.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` |
...
### `supabase/functions/_shared/endurance-library/` — 6 files · anything in it → 12 functions

`analyze-running-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `materialize-plan` · `rematerialize-standing-block` · `swap-session` · `workout-detail`

| touch this file | redeploy these |
|---|---|
| `anchors.ts` | `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-session` |
| `classification.ts` | `analyze-running-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-session` · `workout-detail` |
| `generate.ts` | `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-session` |
| `index.ts` | `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-session` |
| `source-rules.ts` | `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `materialize-plan` · `rematerialize-standing-block` · `swap-session` |
| `types.ts` | `analyze-running-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `materialize-plan` · `rematerialize-standing-block` · `swap-session` · `workout-detail` |
...
### `supabase/functions/_shared/standing-plan/` — 27 files · anything in it → 13 functions

`analyze-strength-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `get-week` · `rematerialize-standing-block` · `save-baseline-test` · `strength-test-session` · `swap-session`

| touch this file | redeploy these |
|---|---|
| `accessory-picks.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` |
| `compose.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `rematerialize-standing-block` |
| `day-map.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` |
...
| `frames.ts` | `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` · `swap-session` |
...
| `sport-slots.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `rematerialize-standing-block` |
...
| `working-number.ts` | `analyze-strength-workout` · `coach` · `compute-session-boom` · `compute-snapshot` · `create-goal-and-materialize-plan` · `endurance-checkpoint` · `generate-strength-plan` · `get-arc-context` · `get-week` · `rematerialize-standing-block` · `save-baseline-test` · `strength-test-session` · `swap-session` |

### `supabase/functions/_shared/state-trend/` — 27 files · anything in it → 30 functions
...
### `supabase/functions/_shared/strength-grid/` — 4 files · anything in it → 27 functions
...
### `supabase/functions/_shared/strength/` — 9 files · anything in it → 36 functions
...
| `rest-seconds.ts` | `coach` · `compute-session-boom` · `endurance-checkpoint` · `generate-strength-plan` · `get-week` · `materialize-plan` · `rematerialize-standing-block` · `workout-detail` |
...
### `supabase/functions/generate-combined-plan/` — 2 files · anything in it → 25 functions
...
### `supabase/functions/generate-run-plan/` — 3 files · anything in it → 27 functions
...
### `supabase/functions/save-baseline-test/` — 1 file · anything in it → 3 functions

`analyze-strength-workout` · `rematerialize-standing-block` · `save-baseline-test`

| touch this file | redeploy these |
|---|---|
| `pick.ts` | `analyze-strength-workout` · `rematerialize-standing-block` · `save-baseline-test` |
