...
| `resolve-current-lthr.ts` | `analyze-cycling-workout` · `analyze-running-workout` · `calculate-workload` · `coach` · `compute-adaptation-metrics` · `compute-facts` · `compute-workout-analysis` · `generate-run-plan` · `learn-fitness-profile` |
...
| `athlete-snapshot.ts` | `generate-combined-plan` · `generate-run-plan` · `generate-triathlon-plan` · `materialize-plan` |
...
| `group-ride-route-snapshot.ts` | `adapt-plan` · `analyze-cycling-workout` · `analyze-running-workout` · `arc-setup-chat` · `coach` · `complete-race` · `compute-adaptation-metrics` · `compute-snapshot` · `compute-workout-analysis` · `course-detail` · `course-strategy` · `create-goal-and-materialize-plan` · `delete-plan` · `end-plan` · `fetch-strava-route` · `generate-combined-plan` · `generate-run-plan` · `generate-strength-plan` · `generate-triathlon-plan` · `get-arc-context` · `import-strava-history` · `learn-fitness-profile` · `materialize-plan` · `planning-context` · `refresh-goal-race-projections` · `rematerialize-standing-block` · `strava-webhook` · `workout-detail` |
...
| `plan-week.ts` | `adapt-plan` · `analyze-cycling-workout` · `analyze-running-workout` · `analyze-strength-workout` · `analyze-swim-workout` · `arc-setup-chat` · `coach` · `complete-race` · `compute-adaptation-metrics` · `compute-snapshot` · `compute-workout-analysis` · `course-detail` · `course-strategy` · `create-goal-and-materialize-plan` · `delete-plan` · `end-plan` · `generate-combined-plan` · `generate-run-plan` · `generate-strength-plan` · `generate-triathlon-plan` · `get-arc-context` · `get-week` · `import-strava-history` · `learn-fitness-profile` · `materialize-plan` · `planning-context` · `refresh-goal-race-projections` · `rematerialize-standing-block` · `rematerialize-strength-block` · `strava-webhook` · `workout-detail` |
...
| `require-user.ts` | `adapt-plan` · `auto-attach-planned` · `backfill-strength-load` · `calculate-workload` · `detach-planned` · `disconnect-connection` · `fetch-strava-route` · `get-arc-context` · `rematerialize-standing-block` · `rematerialize-strength-block` · `resolve-exercise-weight` · `save-baseline-test` · `sweep-user-history` · `sweep-week` · `weekly-workload` |
...
| `strava-access-token.ts` | `fetch-strava-route` |
| `strength-equipment-tier.ts` | `create-goal-and-materialize-plan` · `generate-combined-plan` · `materialize-plan` |
| `strength-profiles.ts` | `adapt-plan` · `analyze-cycling-workout` · `analyze-running-workout` · `analyze-strength-workout` · `arc-setup-chat` · `coach` · `complete-race` · `compute-adaptation-metrics` · `compute-snapshot` · `compute-workout-analysis` · `course-detail` · `course-strategy` · `create-goal-and-materialize-plan` · `delete-plan` · `end-plan` · `generate-combined-plan` · `generate-run-plan` · `generate-strength-plan` · `generate-triathlon-plan` · `get-arc-context` · `get-week` · `import-strava-history` · `learn-fitness-profile` · `materialize-plan` · `planning-context` · `refresh-goal-race-projections` · `rematerialize-standing-block` · `strava-webhook` · `workout-detail` |
...
| `index.ts` | `coach` · `generate-strength-plan` · `rematerialize-standing-block` |
...
### `supabase/functions/_shared/endurance-library/` — 6 files · anything in it → 4 functions

`coach` · `compute-snapshot` · `generate-strength-plan` · `rematerialize-standing-block`

| touch this file | redeploy these |
|---|---|
| `anchors.ts` | `coach` · `compute-snapshot` · `generate-strength-plan` · `rematerialize-standing-block` |
| `classification.ts` | `coach` · `compute-snapshot` · `generate-strength-plan` · `rematerialize-standing-block` |
| `generate.ts` | `coach` · `compute-snapshot` · `generate-strength-plan` · `rematerialize-standing-block` |
| `index.ts` | `coach` · `compute-snapshot` · `generate-strength-plan` · `rematerialize-standing-block` |
| `source-rules.ts` | `coach` · `compute-snapshot` · `generate-strength-plan` · `rematerialize-standing-block` |
| `types.ts` | `coach` · `compute-snapshot` · `generate-strength-plan` · `rematerialize-standing-block` |

### `supabase/functions/_shared/endurance/` — 5 files · anything in it → 1 function
...
### `supabase/functions/_shared/standing-plan/` — 22 files · anything in it → 4 functions
...
### `supabase/functions/_shared/state-trend/` — 24 files · anything in it → 27 functions
...
| `capacity-resolver.ts` | `analyze-cycling-workout` · `coach` · `compute-snapshot` · `workout-detail` |
...
| `reconcile.ts` | `analyze-cycling-workout` · `coach` · `compute-snapshot` · `workout-detail` |
| `run.ts` | `adapt-plan` · `analyze-cycling-workout` · `analyze-running-workout` · `arc-setup-chat` · `coach` · `complete-race` · `compute-adaptation-metrics` · `compute-snapshot` · `compute-workout-analysis` · `course-detail` · `course-strategy` · `create-goal-and-materialize-plan` · `delete-plan` · `end-plan` · `generate-combined-plan` · `generate-run-plan` · `generate-strength-plan` · `generate-triathlon-plan` · `get-arc-context` · `import-strava-history` · `learn-fitness-profile` · `materialize-plan` · `planning-context` · `refresh-goal-race-projections` · `rematerialize-standing-block` · `strava-webhook` · `workout-detail` |
...
| `week-accent.ts` | `analyze-cycling-workout` · `coach` · `compute-snapshot` · `generate-strength-plan` · `rematerialize-standing-block` · `workout-detail` |
...
### `supabase/functions/_shared/strength/` — 5 files · anything in it → 11 functions

`adapt-plan` · `analyze-cycling-workout` · `analyze-running-workout` · `analyze-strength-workout` · `auto-attach-planned` · `coach` · `compute-snapshot` · `create-goal-and-materialize-plan` · `get-week` · `rematerialize-strength-block` · `workout-detail`

| touch this file | redeploy these |
|---|---|
| `all-out-set.ts` | `coach` · `compute-snapshot` · `workout-detail` |
| `match-exercises.ts` | `analyze-strength-workout` · `auto-attach-planned` |
| `performed-set.ts` | `analyze-strength-workout` |
...
### `supabase/functions/_shared/week-model/` — 4 files · anything in it → 3 functions

`coach` · `generate-strength-plan` · `rematerialize-standing-block`

| touch this file | redeploy these |
|---|---|
| `fixture.ts` | — nothing bundles it |
| `model.ts` | `coach` · `generate-strength-plan` · `rematerialize-standing-block` |
| `resolve.ts` | `coach` · `generate-strength-plan` · `rematerialize-standing-block` |
