...
### `src/lib/` — 27 files · anything in it → 40 functions
...
| `band-assistance.ts` | `activate-plan` · `analyze-strength-workout` · `backfill-planned-workload` · `backfill-strength-load` · `calculate-workload` · `coach` · `compute-facts` · `compute-snapshot` · `materialize-plan` · `rematerialize-standing-block` · `workout-detail` |
| `bar-types.ts` | `activate-plan` · `backfill-planned-workload` · `backfill-strength-load` · `calculate-workload` · `coach` · `compute-facts` · `materialize-plan` · `rematerialize-standing-block` · `workout-detail` |
...
| `friel-zones.ts` | `analyze-running-workout` · `compute-facts` · `compute-workout-analysis` · `generate-run-plan` · `learn-fitness-profile` · `materialize-plan` · `save-imported-workout` |
...
| `strength-logging-mode.ts` | `activate-plan` · `backfill-planned-workload` · `backfill-strength-load` · `calculate-workload` · `coach` · `compute-facts` · `materialize-plan` · `rematerialize-standing-block` · `workout-detail` |
...
| `schedule-session-constraints.ts` | `adapt-plan` · `create-goal-and-materialize-plan` · `generate-combined-plan` · `generate-run-plan` · `generate-triathlon-plan` |
...
| `workload.ts` | `activate-plan` · `backfill-planned-workload` · `backfill-strength-load` · `calculate-workload` · `coach` · `compute-facts` · `materialize-plan` · `rematerialize-standing-block` · `workout-detail` |
...
### `supabase/functions/_shared/state-trend/` — 24 files · anything in it → 29 functions
