...
- **Decisions:** see D-003, D-004, D-005, D-006 (D-006/Q-001: swim+upper has no AM/PM ordering — discipline-rank "swim above upper" is the intended cosmetic; not pref-driven, do not "fix").
