...
| **max HR** | ❌ **none** (`resolveMaxHrCeiling` is a plausibility ceiling, not a value resolver) | — | 🟡 scattered fallbacks (`180` / `220−age` / Tanaka / `obsMax÷0.95`). **NEXT: #5 in `AUDIT-hr-congruence-2026-07-17.md`** — one resolver, same pattern as LTHR/FTP. |
