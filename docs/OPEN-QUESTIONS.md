...
- **Status:** filed 2026-07-11 (audit-surfaced) · science-band sign-off owed · not a lie for Michael, a rigor gap.
...
- **Status:** filed 2026-07-11 (audit-surfaced) · robustness gap (user-agnostic), not a live Michael lie · rollup is architecturally single-source (one compute site, `assemble.ts:319` → coach), just quality-fragile.
...
- **Status:** filed 2026-07-11 (spotted on a bike ride, survives recompute → structural) · small clean fix.
