...
### Q-157 — Run efficiency chart label: a competing verdict the workout shouldn't stamp (2026-07-11, SCOPED, deferred to a fresh chat)
...
### Q-158 — Run HR-drift "normal for X min" uses a phase/weather-BLIND band (2026-07-11, SCOPED, deferred)
