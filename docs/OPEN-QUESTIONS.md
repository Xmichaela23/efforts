...
- **Status:** updated 2026-06-30 · **WIRE BUILT, OPEN pending LIVE verification — do NOT log "blocks compound" closed until a dogfood retest log is seen to update `performance_numbers`.**
