...
- **H1 — ✅ FIXED (D-231 resolver).** The bench row is no longer baseline-blind: the canonical capacity resolver (`resolveStrengthCapacity`, wired at `coach/index.ts:2040`/`2346`, acceptance-passed 2026-07-02 per Q-111) means the row now CITES the typed 150 anchor ("Working ~125 vs your 150 baseline — suggest 115"). The residual "suggest 115 / back off" *tone* being context-blind (ignores the just-finished marathon block + active rebuild plan) is **Q-111**, NOT baseline-blindness. ⚠ *Live `StateTab` row rendering off the resolver end-to-end not fully traced — high confidence, not nailed.*
