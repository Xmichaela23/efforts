...
- **Cross-ref:** D-162 (capture + note), D-182 (source single-sourcing — the pace this pollutes is now correct *and* consistent, but still fin-blended), Q-038 (swim pace reliability), `supabase/functions/_shared/state-trend/swim.ts`, AUDIT-swim.
